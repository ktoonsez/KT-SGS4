...
/* For 350Cd (Rev. J) */
static char samsung_brightness_aor_91p1[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x06, 0xE1,
};

static char samsung_brightness_aor_90p1[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x06, 0xCF,
};
...
static char samsung_brightness_aor_88p4[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x06, 0xAD,
};
...
static char samsung_brightness_aor_86p6[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x06, 0x8A,
};

static char samsung_brightness_aor_85p7[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x06, 0x79,
};

static char samsung_brightness_aor_84p7[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x06, 0x67,
};

static char samsung_brightness_aor_83p00[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x06, 0x45,
};
...
static char samsung_brightness_aor_81p2[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x06, 0x22,
};

static char samsung_brightness_aor_80p3[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x06, 0x11,
};

static char samsung_brightness_aor_78p5[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x05, 0xEE,
};

static char samsung_brightness_aor_77p6[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x05, 0xDD,
};

static char samsung_brightness_aor_75p8[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x05, 0xBA,
};

static char samsung_brightness_aor_74p0[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x05, 0x98,
};

static char samsung_brightness_aor_73p2[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x05, 0x87,
};

static char samsung_brightness_aor_71p3[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x05, 0x63,
};

static char samsung_brightness_aor_69p5[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x05, 0x40,
};

static char samsung_brightness_aor_66p8[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x05, 0x0B,
};

static char samsung_brightness_aor_64p9[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x04, 0xE8,
};

static char samsung_brightness_aor_63p1[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x04, 0xC5,
};

static char samsung_brightness_aor_60p3[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x04, 0x8F,
};

static char samsung_brightness_aor_57p5[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x04, 0x59,
};

static char samsung_brightness_aor_54p8[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x04, 0x23,
};

static char samsung_brightness_aor_51p9[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x03, 0xEC,
};

static char samsung_brightness_aor_49p1[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x03, 0xB6,
};

static char samsung_brightness_aor_45p4[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x03, 0x6E,
};

static char samsung_brightness_aor_41p4[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x03, 0x21,
};

static char samsung_brightness_aor_37p5[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x02, 0xD5,
};

static char samsung_brightness_aor_33p6[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x02, 0x89,
};

static char samsung_brightness_aor_28p7[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x02, 0x2C,
};

static char samsung_brightness_aor_23p3[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x01, 0xC3,
};

static char samsung_brightness_aor_17p1[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x01, 0x4B,
};

static char samsung_brightness_aor_13p6[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x01, 0x07,
};

static char samsung_brightness_aor_8p3[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x00, 0xA1,
};

static char samsung_brightness_aor_1p0[] = {
	0xB2,
	0x09, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x14,
};
...
static struct dsi_cmd_desc samsung_on_cmds_revJ[] = {
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,
		sizeof(samsung_test_key_on1), samsung_test_key_on1},
...
static int get_candela_index_350(int bl_level)
{
	int backlightlevel;
...
/* ELVSS for SMART ELVSS(acl off) & SMART ACL(acl on) */
static int normal_elvss_array[][2] = { /* ACL Off Case */
	{5,  0x00},	/* default*/
	{105, 0x13},	/* 105CD 0*/
	{111, 0x0F},	/* 111CD 1*/
	{119, 0x0E},	/* 119CD 2*/
...
#define NORMAL_EVLSS_ARRAY_SIZE (sizeof(normal_elvss_array)/sizeof(normal_elvss_array[0]))

static int smart_acl_elvss_array[][2] = { /* ACL On Case */
	{5,  0x00},	/* default*/
	{105, 0x17},	/* 105CD 0*/
	{111, 0x13},	/* 111CD 1*/
	{119, 0x12},	/* 119CD 2*/
...
#define SMART_ACL_EVLSS_ARRAY_SIZE (sizeof(smart_acl_elvss_array)/sizeof(smart_acl_elvss_array[0]))
...
static int get_elvss_value(int candela, int id3)
{
	...
	if ((id3 == EVT1_ID) || (id3 == EVT1_FIRST_ID) || (id3 == EVT1_SECOND_ID)
		...
		|| (id3 == EVT1_REV_J_ID3_1) || (id3 == EVT1_REV_J_ID3_2))
		default_elvss = DEFAULT_ELVSS_EVT1;
	else
		default_elvss = DEFAULT_ELVSS;

	if (mipi_pd.support_smart_acl) { /* SMART ACL Support */
		if(mipi_pd.acl_status || mipi_pd.siop_status) { /* ACL On Case */
			for (i=0; i< NORMAL_EVLSS_ARRAY_SIZE-1; i++) {
				if(candela > normal_elvss_array[i][0] &&
					candela <= normal_elvss_array[i+1][0])
				{
					pr_debug("%s : candela = %d, elvss_array[%d+1][1] = %x\n",
						__func__, candela, i, normal_elvss_array[i+1][1]);
					elvss_value = default_elvss + normal_elvss_array[i+1][1];
					break;
				}
			}
		} else { /* ACL Off Case */
			for (i=0; i< SMART_ACL_EVLSS_ARRAY_SIZE-1; i++) {
				if(candela > smart_acl_elvss_array[i][0] &&
					candela <= smart_acl_elvss_array[i+1][0])
				{
					pr_debug("%s : candela = %d, elvss_array[%d+1][1] = %x\n",
						__func__, candela, i, smart_acl_elvss_array[i+1][1]);
					elvss_value = default_elvss + smart_acl_elvss_array[i+1][1];
					break;
				}
			}
		}
	} else { /* Do not Support SMART ACL */
		if (candela <= 105) {
...
static void aor_copy_revJ(int candela)
{
	if (candela >= 183) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_0,
					sizeof(samsung_brightness_aor_ref));
		...
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_1p0,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 98) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_8p3,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 93) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_13p6,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 87) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_17p1,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 82) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_23p3,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 77) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_28p7,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 72) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_33p6,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 68) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_37p5,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 64) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_41p4,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 60) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_45p4,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 56) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_49p1,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 53) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_51p9,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 50) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_54p8,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 47) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_57p5,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 44) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_60p3,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 41) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_63p1,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 39) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_64p9,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 37) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_66p8,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 34) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_69p5,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 32) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_71p3,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 30) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_73p2,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 29) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_74p0,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 27) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_75p8,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 25) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_77p6,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 24) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_78p5,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 22) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_80p3,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 21) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_81p2,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 20) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_82p1,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 19) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_83p00,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 17) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_84p7,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 16) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_85p7,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 15) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_86p6,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 14) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_87p4,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 13) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_88p4,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 12) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_89p2,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 11) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_90p1,
					sizeof(samsung_brightness_aor_ref));
	} else if (candela == 10) {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_91p1,
					sizeof(samsung_brightness_aor_ref));
	} else {
		memcpy(samsung_brightness_aor_ref, samsung_brightness_aor_ref,
					sizeof(samsung_brightness_aor_ref));
...
static int brightness_control(int bl_level)
{
	...
	*/
	...
	if ((id3 == EVT1_REV_J_ID3_1) || (id3 == EVT1_REV_J_ID3_2))
		candela = lux_tbl[get_candela_index_350(bl_level)];
	else
...
static int cmd_set_change(int cmd_set, int panel_id)
{
	...
	case PANEL_ON:
		if (id1 == 0x00) {
			...
			mipi_pd.support_smart_acl = FALSE;
			mipi_pd.ldi_rev = 'B';
		} else if (id1 == 0x20) {
			mipi_pd.on.cmd = samsung_on_cmds_revB;
			mipi_pd.on.size =
			...
			samsung_elvss_condition[1] = 0x2C;
			mipi_pd.on.cmd = samsung_on_cmds_revJ;
			mipi_pd.on.size =
				ARRAY_SIZE(samsung_on_cmds_revJ);
			mipi_pd.support_smart_acl = TRUE;
			mipi_pd.ldi_rev = 'J';
		} else { /*id3 0x02, 0x03*/
