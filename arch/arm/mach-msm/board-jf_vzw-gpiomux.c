...
#ifndef CONFIG_KEYBOARD_CYPRESS_TOUCH_236
	{	/* TS SLEEP */
		.gpio = 33,
		.settings = {
...
static struct gpiomux_setting tkey_init_state = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting tkey_sleep_state = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};

static struct msm_gpiomux_config apq8064_tkey_config[] = {
	{
		.gpio = 26,	/* tkey_scl_config */
		.settings = {
			[GPIOMUX_SUSPENDED] = &tkey_sleep_state,
			[GPIOMUX_ACTIVE] = &tkey_init_state,
		},
	},
	{
		.gpio = 33,	/* tkey_sda_config */
		.settings = {
			[GPIOMUX_SUSPENDED] = &tkey_sleep_state,
			[GPIOMUX_ACTIVE] = &tkey_init_state,
		},
